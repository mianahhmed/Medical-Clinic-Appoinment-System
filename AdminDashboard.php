...
<html>
<head>
    <title>AdminDashboard - ABUDA MED</title>
    <style>
		body {
			font-family: Arial;
			margin: 0;
...
<div class="mid">
    <div class="box">
        <div class="Panel"><a href="AdDoctor.php">Doctors</a></div>
        <div class="Panel"><a href="AdPatients.php">Patients</a></div>
        <div class="Panel"><a href="AdAppointments.php">Appointments</a></div>
        <div class="Panel"><a href="AdPayments.php">Payments</a></div>
